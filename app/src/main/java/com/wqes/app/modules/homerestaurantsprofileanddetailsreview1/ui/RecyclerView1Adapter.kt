...
public class RecyclerView1Adapter(
...
) : RecyclerView.Adapter<RecyclerView1Adapter.RowHomeRestaurantsProfileAndDetailsReview2VH>() {
  ...
  public override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
    ...
    val
        view=LayoutInflater.from(parent.context).inflate(R.layout.row_home_restaurants_profile_and_details_review_2,parent,false)
